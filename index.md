...
As I like being woken up by sunrise and I also close my curtains every night before I go to sleep, I needed a way to have them open automatically. Aside from Raspberry Pi itself, every component is worth around $1.
...
5V power supply of our raspberry (red jumper cable)
Ground (black jumper cable)
4 GPIO pins: 4, 17, 23, 24 consecutively.

After everything is connected, let’s glue it into our plastic box.
...
Fortunately, Raspberry Pi offers tons of useful drivers to handle its GPIO pins. I chose Python and the source code can be found either here:

GitHub gist:    https://gist.github.com/psarna/e93ceb5e03ed0a1de8c6edde24ab573e
or GitHub:    https://github.com/psarna/gpio/blob/master/stepper.py
